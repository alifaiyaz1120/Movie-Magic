    ...
    return Padding(
      ...
      child: ElevatedButton(
        onPressed: () {
          ...
          _authenticateFirebaseUser(email, password);
          _registerUser(firstName, lastName, email, password);
        },
        style: ElevatedButton.styleFrom(
          backgroundColor: const Color.fromRGBO(
              255, 255, 255, 1), // Set button background color to white
          foregroundColor:
...
//Function to add users to Firebase Authentication
void _authenticateFirebaseUser(String email, String password) async {
  try {
    ...
    print('User successfully authenticated in Firebase: ${user}');
  } catch (e) {
    print('Error authenticating user in Firebase: ${e}');
  }
}
